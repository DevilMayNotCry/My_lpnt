...
def parse(opt_path, is_train=True):
    ...
    if is_train:
        experiments_root = '/content/drive/MyDrive/curl/LPTN/'
        # experiments_root = osp.join('/data1/liangjie/experiments_runing', opt['name'])
        ...
        results_root = '/content/drive/MyDrive/curl/LPTN/'
        opt['path']['results_root'] = results_root
        opt['path']['log'] = osp.join(results_root, 'val_log')
